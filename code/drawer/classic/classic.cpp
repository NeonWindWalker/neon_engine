...
ClassicDrawer::ClassicDrawer(const DisplayHandle& display) : ForwardDrawer(display)
{
	if(isValid())
		init();
}

ClassicDrawer::ClassicDrawer(IFrameWindow*& outMainWnd, const WindowHandle& srcWainWindowHandle, boolean fullscrean, boolean stereo)
...
TextureBase* ClassicDrawer::getSpecularTexture()
{
	if(specularTexture)
...
void ClassicDrawer::draw(Range<DrawTask*> parallelTasks)
{
...
const ClassicDrawer::MeshShaderProgramAndParameters& ClassicDrawer::getMeshProgram(MeshShaderProgramIndex params)
{
	boolean bNew;
...
const ClassicDrawer::WaterPlaneShaderProgramAndParameters& ClassicDrawer::getWaterPlaneProgram(WaterPlaneShaderProgramIndex params)
{
	boolean bNew;
...
const ClassicDrawer::DepthOnlyMeshShaderProgramAndParameters& ClassicDrawer::getDepthOnlyMeshProgram(DepthOnlyMeshShaderProgramIndex params)
{
	boolean bNew;
...
void ClassicDrawer::VertexShaderAndParameters::init(ShaderProgram* prog)
{
...
void ClassicDrawer::MeshShaderProgramAndParameters::init(ShaderProgram* prog)
{
	program = prog;
...
void ClassicDrawer::WaterPlaneShaderProgramAndParameters::init(ShaderProgram* prog)
{
	program = prog;
	VertexShaderAndParameters::init(prog);
...
void ClassicDrawer::DepthOnlyMeshShaderProgramAndParameters::init(ShaderProgram* prog)
{
	program = prog;
	GET_SHADER_PARAMETER_INDEX(prog, FullTransformMatrix);
	GET_SHADER_PARAMETER_INDEX(prog, TexCoordMatrix);
