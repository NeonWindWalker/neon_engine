...
String ClassicDrawer::getMeshVertexShaderCode(MeshVertexShaderIndex params)
{
	const char* str =
...
String ClassicDrawer::getMeshPixelShaderCode(MeshPixelShaderIndex params)
{
	const char* str =
	"varying highp vec2 vrTexCoord;\n"
	"varying mediump vec2 vrOpacityOpacity2;\n"
...
String ClassicDrawer::getWaterPlanePixelShaderCode(WaterPlanePixelShaderIndex params)
{
	const char* str =
	"\n"
	"varying highp vec2 vrTexCoord;\n"
...
String ClassicDrawer::getParticlesVertexShaderCode()
{
	const char* str =
	"uniform highp vec4 FullTransformMatrix[4];\n"
	"\n"
...
String ClassicDrawer::getParticlesPixelShaderCode(boolean bDualTex)
{
	const char* str =
	"varying highp vec2 vrTexCoord0;\n"
	"#ifdef DUAL_TEXURES\n"
...
String ClassicDrawer::getDepthOnlyMeshVertexShaderCode(DepthOnlyMeshVertexShaderIndex params)
{
	const char* str =
	"uniform highp vec4 FullTransformMatrix[4];\n"
	"uniform highp vec4 TexCoordMatrix[3];\n"
...
String ClassicDrawer::getDepthOnlyMeshPixelShaderCode(DepthOnlyMeshPixelShaderIndex params)
{
	const char* str =
	"#ifdef ALPHA_TEST\n"
	"	varying highp vec2 vrTexCoord;\n"
