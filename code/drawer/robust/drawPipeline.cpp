...
void RobustDrawer::draw(DrawTask& task, boolean interfaceSubViewport)
{
...
void RobustDrawer::setLightProbeParameters(const VertexShaderAndParameters& prog, const LightProbeBase& lp)
{
	switch(lp.type)
	{
...
void RobustDrawer::drawBatch(BatchBase& baseBatch, const Matrix44& viewAndProj, const Matrix34& toEyeMatrix, float sensitivity, boolean alphaTest)
{
	switch(baseBatch.type)
	{
