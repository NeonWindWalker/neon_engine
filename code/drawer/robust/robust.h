...
{
	template<>
	class DefaultHashGen<const DrawerLib::MeshVertexShaderIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::MeshVertexShaderIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::MeshPixelShaderIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::MeshPixelShaderIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::MeshShaderProgramIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::MeshShaderProgramIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::WaterPlanePixelShaderIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::WaterPlanePixelShaderIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::WaterPlaneShaderProgramIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::WaterPlaneShaderProgramIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};


	template<>
	class DefaultHashGen<const DrawerLib::DepthOnlyMeshVertexShaderIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::DepthOnlyMeshVertexShaderIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::DepthOnlyMeshPixelShaderIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::DepthOnlyMeshPixelShaderIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};

	template<>
	class DefaultHashGen<const DrawerLib::DepthOnlyMeshShaderProgramIndex>
	{
	public:
		INLINE Hash operator () (const DrawerLib::DepthOnlyMeshShaderProgramIndex& key){ return DefaultHashGen<const uint32>()(key.number); }
	};
}
...
class RobustDrawer : public ForwardDrawer
{
public:
	RobustDrawer(const DisplayHandle& display);
	RobustDrawer(IFrameWindow*& outMainWnd, const WindowHandle& srcWainWindowHandle, boolean fullscrean, boolean stereo);
	~RobustDrawer();
